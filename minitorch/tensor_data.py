...
class TensorData:
    ...
    def shape_broadcast(shape_a: UserShape, shape_b: UserShape) -> UserShape:
        """Broadcast two shapes to create a new shape according to broadcasting rules.
    ...
    def index(self, index: Union[int, UserIndex]) -> int:
        """Convert a multidimensional index into a single-dimensional storage index.

        Parameters
        ----------
        index : Union[int, UserIndex]
            Multidimensional index or a single integer.

        Returns
        -------
        int
            Single-dimensional index in storage.

        Raises
        ------
        IndexingError
            If the index is out of bounds or if negative indexing is used.
    ...
    def indices(self) -> Iterable[UserIndex]:
        """Yield all possible valid indices for the tensor in a multi-dimensional form.

        Returns
        -------
        Iterable[UserIndex]
            Iterator over all valid indices for the tensor.
    ...
    def get(self, key: UserIndex) -> float:
        """Get the value at a specific index in the tensor.
